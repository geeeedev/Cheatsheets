...
| | |
| :--- | :--- |
| [Steps to Contribute Method1](https://tharis63.medium.com/git-fork-vs-git-clone-8aad0c0e38c0) | 1. Fork the original repository to your own remote repository <br> 2. Clone from your own remote repo to your local <br> 3. Make changes; contribute to it <br> 4. Push it to your remote repo forked copy <br> 5. Send a PR to the source repo from your forked merged GitHub copy <br> 6. If the owner of the source repo is okay with your contribution they will merge your changes with the original repository.  <br> |
| [Steps to Contribute Method2](https://tharis63.medium.com/git-fork-vs-git-clone-8aad0c0e38c0) | ~~1. Fork the original repository to your own remote repository~~ (realistically many projects skip this step) <br> 1. Clone from source origin remote repo to your local <br> 2. Create a new branch with Ticket ID or your name on it <br> 3. Make changes; contribute to this branch of yours <br> ~~4. Push it to your remote repo forked copy~~ <br> ??this step needs update ~~5. Send a PR to the main repo from your forked merged GitHub copy~~ <br> 6. If the owner of the source repo is okay with your contribution they will merge your changes with the original repository.  <br> |
...
| `git pull` | retrieve the latest meta-data AND bring/copy those changes from the connected remote repository to your current local directory |  |
